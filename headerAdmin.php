...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top" style="margin-bottom: 1.5rem !important;">
        <a class="navbar-brand" href="pages/home.php">Test Practice <span class="highlight" style="color:#009fff; font-weight: lighter;">ТДМУ</span> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php"> Oral Answers </a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="https://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item" href="index.php">Total MCQ List</a>
                        <a class="dropdown-item" href="index.php">Total MCQ Practice</a>
                        <a class="dropdown-item" href="index.php">48 MCQ Practice</a>
                        <a class="dropdown-item" href="admin.php">Admin</a>
                    </div>
                </li>
            </ul>
            <form class="form-inline my-2 my-lg-0" action="includes/adminsignout.inc.php">
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link disabled" href="pages/demo.php"> Demo </a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="https://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
