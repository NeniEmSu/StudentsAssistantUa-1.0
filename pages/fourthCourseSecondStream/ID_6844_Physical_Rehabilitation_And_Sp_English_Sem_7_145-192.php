...
<main role="" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <h1 class="demoheader">ID_6844_Physical_Rehabilitation_And_Sp_English_Sem_7_145-192</h1>
    <div style="margin:0; font-weight:bold;">You have <span id="timer" style="color:#009fff;"></span> minutes left for this practice!</div>
    <div class="quiz-container" style="position: relative; height: 350px; margin-top: 10px; padding: 2px;">
        <div id="quiz"></div>
    </div>
...
<!-- Link to JavaScript for Javascript for quetions -->
<script src="js/js4c2s/ID_6844_Physical_Rehabilitation_And_Sp_English_Sem_7_145-192.js"></script>
