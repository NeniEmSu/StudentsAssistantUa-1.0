...
<main role="" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <h1 class="demoheader">ID_7514_Phthisiology_Situational_English_Sem_7_1-48</h1>
...
<script src="js/js4c2s/ID_7514_Phthisiology_Situational_English_Sem_7_1-48.js"></script>
