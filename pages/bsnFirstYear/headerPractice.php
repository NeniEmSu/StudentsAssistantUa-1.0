...
<head>
    ...
    <title>Test Practice Fifth Year First Stream</title>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top" style="margin-bottom: 1.5rem !important;">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="fifthYearFirstStream_index.php"> Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="fifthYearFirstStream_index.php"> Dashboard </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="oralAnswers_5c1s.php"> Oral Answers </a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="https://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item" href="total_MCQ_List_5c1s.php">Total MCQ List</a>
                        <a class="dropdown-item" href="total_MCQ_Practice_5c1s.php">Total MCQ Practice</a>
                        <a class="dropdown-item" href="t48_MCQ_Practice_5c1s.php">48 MCQ Practice</a>
                    </div>
                </li>
            </ul>
   ...
   <body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top" style="margin-bottom: 1.5rem !important;">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="bsnFirstYear_index.php"> Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="#"> Dashboard </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="oralAnswers_.php"> Oral Answers </a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href=bsn1y"https://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item" href="#">Total MCQ List</a>
                        <a class="dropdown-item" href="#">Total MCQ Practice</a>
                        <a class="dropdown-item" href="#">48 MCQ Practice</a>
                    </div>
                </li>
            </ul>
            <form class="form-inline my-2 my-lg-0" action="../../includes/logout.inc.php">
