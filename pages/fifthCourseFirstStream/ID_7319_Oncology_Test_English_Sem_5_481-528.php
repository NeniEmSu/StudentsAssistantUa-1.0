...
<main role="" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <h1 class="demoheader">ID_7319_Oncology 481-501</h1>
    <!--    <div style="margin:0; font-weight:bold;">You have <span id="timer" style="color:#009fff;"></span> minutes left for this practice!</div>-->
    <div class="quiz-container" style="position: relative; height: auto; margin-top: 10px; padding: 2px;">
        <div id="quiz"></div>
    </div>
...
<script src="js/js5c1s/ID_7319_Oncology_Test_English_Sem_5_481-528.js"></script>
