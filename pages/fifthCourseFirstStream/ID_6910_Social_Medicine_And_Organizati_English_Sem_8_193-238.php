...
<main role="" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <h1 class="demoheader">ID_6910 Social Medicine And Organization 193-238</h1>
...
<script src="js/js5c1s/ID_6910_Social_Medicine_And_Organizati_English_Sem_8_193-238.js"></script>
