        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="fifthYearFirstStream_index.php">
                            <span data-feather="home"></span>
                            Dashboard <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Total MCQ list_5c1s.php">
                            <span data-feather="layers"></span>
                            Total MCQ list
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Total MCQ practice_5c1s.php">
