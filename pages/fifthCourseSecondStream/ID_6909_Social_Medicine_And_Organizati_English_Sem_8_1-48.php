...
<main role="" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <h1 class="demoheader">ID_6909_Social_Medicine_And_Organization 1-48</h1>
...
<script src="js/js5c2s/ID_6909_Social_Medicine_And_Organizati_English_Sem_8_1-48.js"></script>
