...
<head>
    ...
    <title>Test Practice Fifth Year Second Stream</title>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top" style="margin-bottom: 1.5rem !important;">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="fifthYearSecondStream_index.php"> Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="fifthYearSecondStream_index.php"> Dashboard </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="oralAnswers_5c2s.php"> Oral Answers </a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="https://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item" href="total_MCQ_List_5c2s.php">Total MCQ List</a>
                        <a class="dropdown-item" href="total_MCQ_Practice_5c2s.php">Total MCQ Practice</a>
                        <a class="dropdown-item" href="t48_MCQ_Practice_5c2s.php">48 MCQ Practice</a>
                    </div>
                </li>
            </ul>
